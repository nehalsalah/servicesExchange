...
public class CancelledServicesAdapter extends RecyclerView.Adapter<CancelledServicesAdapter.ViewHolder> {
    List<TransactionDto> serviceList;
    Context context;
    CancelledMVP.Presenter presenter;

    public CancelledServicesAdapter(List<TransactionDto> serviceList, Context context, CancelledMVP.Presenter presenter) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                presenter.cardOnClickAction(trans);
            }
        });
